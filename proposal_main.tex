...
\todo[inline]{Add an overview figure of the visual pathway and where the implants are placed or perhaps of the phasic approach of the experiments.}
...
\todo[inline]{Maybe add the SPV framework image.}
...
\todo[inline]{add more information on why simulator and VR instead of implants?}
...
(VEP) and functional Magnetic Resonance Imaging (fMRI) to study the effects of
